...
while (True):
    ...
    if (Menu == 1):
        ...
        student_number = int(input(f"Enter Student# between 1 and {len(Students)} : " ))
    ...
    # Use elif for when option 2 is selected Menu = 2 
        ...
        if (1<= student_number <= len(Students)):
            ...
            if (update == 1):
                ...
                student.update_Student(FirstName=FirstName)
    ...
    # Menu = 3 this option just print all of Students information by interating in a loop line by line
        ...
        menu3 = int(input("Select Menu option 1,  2 or 3 : "))
        if (menu3 == 1):
